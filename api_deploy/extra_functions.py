...
def read_image(image_id):
    ...
    img=mpimg.imread('/home/ceinfo/Desktop/HELLO/images/'+image_id)
...
def read_image_test(image_id):
    ...
    '''for roads preprocessed images '''
    img=mpimg.imread('/home/ceinfo/Desktop/HELLO/images/'+image_id)[:,:,:3]
...
def read_mask(i):
    ...
    '''for roads preprocessed images '''
    mask = cv2.imread('/home/ceinfo/Desktop/HELLO/images/' + i)
