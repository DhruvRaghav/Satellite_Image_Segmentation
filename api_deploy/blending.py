...
'''images path'''
data_path = '/home/ceinfo/Desktop/out/'
'''mask path '''
data_path1 = '/home/ceinfo/Desktop/images/'
print(data_path)
#num_channels = 3
#num_mask_channels = 1
#threshold = 0.1
...
#
    ...
    os.makedirs("/home/ceinfo/Desktop/images/" + "overlays", exist_ok=True)
    print("5")
    ...
    plt.imsave("/home/ceinfo/Desktop/images/"  +  image_id[:-4] + ".png",alphaBlended2 , dpi=1)
