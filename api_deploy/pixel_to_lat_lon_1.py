...
def geojson(in_file):
    geoimg = geoio.GeoImage(os.path.join('/mnt/vol1/Deployment_projects/satellite_image_segmentation/uploads',in_file+'.tif'))
    ...
    with open('/mnt/vol1/Deployment_projects/satellite_image_segmentation/uploads/122222'+'.geojson','w') as fp:
