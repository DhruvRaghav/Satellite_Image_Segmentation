...
def predict(model,image_id,graph,image_size):
    ...
    with graph.as_default():
     with tf.device('/gpu:0'):
        im = Image.open('/mnt/vol1/DhruvRaghav/PROJECTS/satellite_image_segmentation_deploy_DhruvRaghav/uploads/' + image_id+'.jpg')
        ...
        plt.imsave("/mnt/vol1/DhruvRaghav/PROJECTS/satellite_image_segmentation_deploy_DhruvRaghav/uploads/"+ image_id+'_mask.jpg',
