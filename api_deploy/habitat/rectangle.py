...
image = cv2.imread("/home/ceinfo/Desktop/transfer_9/filename2022-08-04_13:53:40_397500_mask.png")
paper = image.copy()
real = cv2.imread("/home/ceinfo/Desktop/transfer_9/filename2022-08-04_13:59:59_893994.jpg")
abc = real.copy()
...
_, contours, _= cv2.findContours(thresh_gay, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
