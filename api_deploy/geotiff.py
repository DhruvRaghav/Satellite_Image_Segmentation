...
# import gdal
import os
# from  habitat.conversion_tiff_image import *
...
#
#
# def gdal_convert_1(path1,in_file,southwest,northeast):
#
#     try:
#         in_files=os.path.join(path1,in_file+'.jpg')
#         out_files=os.path.join(path1,in_file+'.tif')
...
#         pt2[2] = '(' + southwest[1] + ',' + southwest[0] + ')'
#         f[10] = ' '.join(pt2)
#         with open(os.path.join(path1,in_file+'.TAB'),'w') as fp:
#             fp.writelines(f)
#     except Exception as e:
#         return e
...
def csv(southwest, northeast, path1, imagename):
    import numpy as np
    with open("/mnt/vol1/Project_Deployments/satellite_image_segmentation_deploy_v2/text_file/parameters.txt",
              "w") as f:
        l = [southwest, northeast, path1, imagename]
        f.writelines(str(southwest) + '\n')
        f.write(str(northeast) + '\n')
        f.write(str(path1) + '\n')
        f.write(str(imagename))
        f.close()

    # users = {'southwest': [southwest],
    #          'Northeast': [northeast],
    #          'image_path':[path1+imagename+".jpg"]}
    #
    # # create DataFrame
    # df = pd.DataFrame(users, columns=['southwest', 'Northeast'])
    #
...
#     try:
#         os.system(
#             "/mnt/vol1/Anaconda3/envs/footprints/bin/python3.6  /mnt/vol1/Project_Deployments/satellite_image_segmentation_deploy_v2/gdal.py")
#     except Exception as e:
#         return e
#
# if __name__ == '__main__':
#
#     # gdal_convert("/mnt/vol1/Project_Deployments/satellite_image_segmentation_deploy_v2/api_deploy/uploads03",'filename2022-09-14_15:13:39_440143',['20.55248', '77.53618'],['20.52536', '77.58905'])
#     csv()
