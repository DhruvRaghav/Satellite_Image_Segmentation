...
from geotiff_local import gdal_convert
from pixel_lat_lon_local import *
from predict01 import *
from FP_pixel import *
from Regularize_1 import *
...
def automatic_deletion():
    ...
    path = "/mnt/vol2/Satellite_Results/"
    now = time.time()
    # print(now)
...
def func3(image,bounds,key, scale):
    path = os.getcwd()
    directory = "/mnt/vol2/Satellite_Results"
    parent_dir = path
    # path1 = os.path.join(parent_dir, directory)
    path1='/mnt/vol2/Satellite_Results'
    ...
    print('tiff',datetime.now())
    geojson_v2(path1,in_file)
...
def func1(image,key,scale):
    ...
    image_name = in_file+str(datetime.now())
