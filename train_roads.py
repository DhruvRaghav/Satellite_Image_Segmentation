...
def get_unet_deep():
    ...
    conv1_1 = Conv2D(filters=32, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
                   data_format="channels_last")(inputs)  # xavier initilizer alias
    conv1_1 = BatchNormalization()(conv1_1)
    conv1_1 = keras.layers.advanced_activations.ELU()(conv1_1)
    conv1_1 = Conv2D(filters=32, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
                   data_format="channels_last")(conv1_1)
    conv1_1= BatchNormalization()(conv1_1)
    conv1_1 = keras.layers.advanced_activations.ELU()(conv1_1)
    pool1_1 = MaxPooling2D(pool_size=(2, 2), data_format="channels_last")(conv1_1)

    conv1 = Conv2D(filters=64, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
                   data_format="channels_last")(pool1_1)  # xavier initilizer alias
    ...
    conv2 = Conv2D(filters=128, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    conv3 = Conv2D(filters=256, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    conv4 = Conv2D(filters=512, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    conv5 = Conv2D(filters=1024, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    # conv5_t = Conv2D(filters=2048, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform', data_format="channels_last")(pool5)
    # conv5_t = BatchNormalization()(conv5_t)
    # conv5_t = keras.layers.advanced_activations.ELU()(conv5_t)
    # conv5_t = Conv2D(filters=2048, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform', data_format="channels_last")(conv5_t)
    # conv5_t = BatchNormalization()(conv5_t)
    # conv5_t = keras.layers.advanced_activations.ELU()(conv5_t)
    # pool5_t = MaxPooling2D(pool_size=(2, 2), data_format="channels_last")(conv5_t)

    # conv51 = Conv2D(filters=4096, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(pool5_t)
    # conv51 = BatchNormalization()(conv51)
    # conv51 = keras.layers.advanced_activations.ELU()(conv51)
    # conv51 = Conv2D(filters=4096, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(conv51)
    # conv51 = BatchNormalization()(conv51)
    # conv51 = keras.layers.advanced_activations.ELU()(conv51)

    # up61_t = Conv2DTranspose(filters=2048, kernel_size=(2, 2), padding='valid', strides=(2, 2), data_format="channels_last")(conv51)
    # up61 = Concatenate(axis=-1)([up61_t, conv5_t])
    # conv61_t = Conv2D(filters=2048, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform', data_format="channels_last")(up61)
    # conv61_t = BatchNormalization()(conv61_t)
    # conv61_t = keras.layers.advanced_activations.ELU()(conv61_t)
    # conv61_t = Conv2D(filters=2048, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform', data_format="channels_last")(conv61_t)
    # conv61_t = BatchNormalization()(conv61_t)
    # conv61_t = keras.layers.advanced_activations.ELU()(conv61_t)

    # up61 = Conv2DTranspose(filters = 1024,kernel_size = (2,2),padding='valid', strides = (2,2), data_format="channels_last")(conv5_t)
    ...
    up6 = Conv2DTranspose(filters=512, kernel_size=(2, 2), padding='valid', strides=(2, 2),
                          data_format="channels_last")(conv5)
    up6 = Concatenate(axis=-1)([up6, conv4])
    conv6 = Conv2D(filters=512, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    up7 = Conv2DTranspose(filters=256, kernel_size=(2, 2), padding='valid', strides=(2, 2),
                          data_format="channels_last")(conv6)
    up7 = Concatenate(axis=-1)([up7, conv3])
    conv7 = Conv2D(filters=256, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    up8 = Conv2DTranspose(filters=128, kernel_size=(2, 2), padding='valid', strides=(2, 2),
                          data_format="channels_last")(conv7)
    up8 = Concatenate(axis=-1)([up8, conv2])
    conv8 = Conv2D(filters=128, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    up9 = Conv2DTranspose(filters=64, kernel_size=(2, 2), padding='valid', strides=(2, 2), data_format="channels_last")(
        conv8)
    up9 = Concatenate(axis=-1)([up9, conv1])
    conv9 = Conv2D(filters=64, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform',
    ...
    up9 = Conv2DTranspose(filters = 64,kernel_size = (2,2),padding='valid', strides = (2,2), data_format="channels_last")(conv9)
    up9 = Concatenate(axis=-1)([up9, conv1_1])
    conv9 = Conv2D(filters=32, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(up9)
    conv9 = BatchNormalization()(conv9)
    conv9 = keras.layers.advanced_activations.ELU()(conv9)
    conv9 = Conv2D(filters=32, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(conv9)
    conv9 = BatchNormalization()(conv9)
    conv9 = keras.layers.advanced_activations.ELU()(conv9)
...
if __name__ == '__main__':
    ...
    with tf.device('/device:GPU:0'):
       ...
       # model = get_unet_resnet((None, None,3))
        ...
        f = h5py.File(os.path.join(data_path, 'train_rd_new.h5'), 'r')
        ...
        iters_per_epoch = (X_train.shape[0] * 285) / batch_size
        val_steps = (y_train.shape[0] * 285) / batch_size
        suffix = 'buildings_3_'
    ...
    plt.show()
    fig.savefig("accuracy_test_final.pdf", bbox_inches='tight')
    ...
    plt.legend(['train', 'test'], loc='upper left')
    plt.show()
    fig.savefig("loss_test_final.pdf", bbox_inches='tight')
    f.close()
