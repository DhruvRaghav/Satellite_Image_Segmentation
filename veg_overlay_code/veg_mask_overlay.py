...
# print(geoimg)
        ...
        plt.imsave(r"/home/divya/split_predictions/" + str(image_id) + '_mask.jpg',thresh, cmap='gray', dpi=1)
        Image_pil2=Image.open(r"/home/divya/split_predictions/" + str(image_id) + '_mask.jpg')

        alphaBlended1 = Image.blend(Image_pil, Image_pil2, alpha=.5)
        alphaBlended1=alphaBlended1.save(r"/home/divya/split_prediction_overlay/" + str(image_id) + '_mask.jpg')
