...
def get_unet_deep():
    ...
    conv61_t = Conv2D(filters=2048, kernel_size=(3, 3), padding='same', kernel_initializer='glorot_uniform', data_format="channels_last")(up61_t)
    ...
    up61 = Conv2DTranspose(filters = 1024,kernel_size = (2,2),padding='valid', strides = (2,2), data_format="channels_last")(conv61_t)
...
if __name__ == '__main__':
    ...
    with tf.device('/device:GPU:0'):
        ...
        f = h5py.File(os.path.join(data_path, 'train_fp2022.h5'), 'r')
    ...
    plt.show()
    fig.savefig("accuracy_test_2022_fp.pdf", bbox_inches='tight')
    ...
    plt.legend(['train', 'test'], loc='upper left')
    plt.show()
    fig.savefig("loss_test_2022_fp.pdf", bbox_inches='tight')
    f.close()
