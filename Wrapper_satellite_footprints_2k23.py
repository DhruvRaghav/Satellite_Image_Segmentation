...
async def habitation(geotag: str = Form(default=None),
    ...
    try:
        ...
        url1 = 'http://10.10.21.120:7007/satellite_FP/'
...
async def habitation(geotag: str = Form(default=None),
    ...
    try:
        ...
        # url1 = 'http://10.10.21.120:7007/satellite_FP/'
        url1 = 'http://10.10.21.120:7007/satellite_RD/'
        clean_file_name = re.sub(r'[^\w.-]', '_', file.filename)
        files = {
            'file': (clean_file_name, file.file),
            'scale': (None, scale),
...
async def habitation(geotag: str = Form(default=None),
    ...
    try:
        ...
        # url1 = 'http://10.10.21.120:7007/satellite_FP/'
        url1 = 'http://10.10.21.120:7006/satellite_VEG/'
        # files = {
...
async def habitation(geotag: str = Form(default=None),
    ...
    try:
        ...
        # url1 = 'http://10.10.21.120:7007/satellite_FP/'
        url1 = 'http://10.10.21.120:7006/satellite_SOIL/'
        clean_file_name = re.sub(r'[^\w.-]', '_', file.filename)
        files = {
            'file': (clean_file_name, file.file),
            'scale': (None, scale),
...
async def habitation(geotag: str = Form(default=None),
    ...
    try:
        ...
        # url1 = 'http://10.10.21.120:7007/satellite_FP/'
        # url1 = 'http://10.10.21.120:7006/satellite_WATER/'
        url1 = 'http://10.10.21.120:7006/satellite_WATER/'
        clean_file_name = re.sub(r'[^\w.-]', '_', file.filename)
        files = {
            'file': (clean_file_name, file.file),
