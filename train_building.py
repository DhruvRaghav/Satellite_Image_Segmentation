...
def get_unet_deep():
    ...
    conv51 = Conv2D(filters=1024, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(pool4)
    conv51 = BatchNormalization()(conv51)
    conv51 = keras.layers.advanced_activations.ELU()(conv51)
    conv51 = Conv2D(filters=1024, kernel_size=(3,3),padding='same', kernel_initializer='glorot_uniform',data_format="channels_last")(conv51)
    conv51 = BatchNormalization()(conv51)
    conv51 = keras.layers.advanced_activations.ELU()(conv51)
    # pool51 = MaxPooling2D(pool_size=(2, 2),data_format="channels_last")(conv51)
    ...
    up6 = Conv2DTranspose(filters = 512,kernel_size = (2,2),padding='valid', strides = (2,2), data_format="channels_last")(conv51)
...
if __name__ == '__main__':
    ...
    with tf.device('/device:GPU:0'):
        ...
        f = h5py.File('/mnt/vol1/Project_Deployments/satellite_image_segmentation_deploy_v2/api_deploy/habitat/weights/train_habitat_sep.h5', 'r')
    ...
    plt.show()
    fig.savefig("accuracy_habitat.pdf", bbox_inches='tight')
    ...
    plt.legend(['train', 'test'], loc='upper left')
    plt.show()
    fig.savefig("loss_habitat.pdf", bbox_inches='tight')
    f.close()
