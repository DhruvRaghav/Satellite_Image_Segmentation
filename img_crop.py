...
import os
import math
root='/mnt/vol1/DhruvRaghav/dataset/building/data_regioWise_mask'
root1='/mnt/vol1/DhruvRaghav/dataset/building/all_image/'
    ...
    for row in range(rows+1):
        ...
        for col in range(columns+1):
            if (col >= int(columns)):
                first1 = width - 256
                last1 = width
            cv2.imwrite('/home/ceinfo/hello/'+image[:-4]+'_'+str(num)+'.jpg',img[first:last,first1:last1])
